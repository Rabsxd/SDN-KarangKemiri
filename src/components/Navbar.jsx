        ...
        <nav className="bg-gray-800 shadow-md">
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:block">
                        <div className="ml-10 flex items-baseline space-x-4">
                            ...
                            <NavLink to="/guru" className={linkClass}>Daftar Guru</NavLink>
                            <NavLink to="/siswa" className={linkClass}>Daftar Siswa</NavLink>
            ...
            <div className={`${isOpen ? 'block' : 'hidden'} md:hidden`} id="mobile-menu">
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    <NavLink to="/" className={mobileLinkClass} onClick={() => setIsOpen(false)}>Beranda</NavLink>
                    <NavLink to="/guru" className={mobileLinkClass} onClick={() => setIsOpen(false)}>Daftar Guru</NavLink>
                    <NavLink to="/siswa" className={mobileLinkClass} onClick={() => setIsOpen(false)}>Daftar Siswa</NavLink>
                    <NavLink to="/berita" className={mobileLinkClass} onClick={() => setIsOpen(false)}>Berita</NavLink>
                </div>
            </div>
        </nav>
    );
